    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            if(isset($_POST["submit"]))
            {
                ...
                //Insertion query
                $query = "UPDATE tasks SET title='$title', priority='$priority', details='$details', deadline='$deadline', status='$status' WHERE id=$id";
            ...
            ?>
                        ...
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Update Task</h6>
                        </div>
                        <div class="card-body">
